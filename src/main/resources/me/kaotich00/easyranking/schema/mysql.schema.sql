...
INSERT INTO easyranking_board(`id`,`name`,`description`,`max_players`,`user_score_name`,`is_visible`,`is_deleted`,`is_default`) VALUES ('fishing','Fisherman','This leaderboard tracks how many fishes has the player fish',100,'fishes',true,false,true) ON DUPLICATE KEY UPDATE `id` = `id`;
